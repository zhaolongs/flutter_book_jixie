...
//Widget的标识GloalKey 
GlobalKey<_InitThemState> langGlobalKey1 = new GlobalKey();

main() => runApp(DateLnaguageSelectPage3(key: langGlobalKey1));
//本地化语言标识
Locale _initLocal;
//本地存储工具
...
//初始化页面
class DateLnaguageSelectPage3 extends StatefulWidget {
  DateLnaguageSelectPage3({Key key}) : super(key: key??langGlobalKey1);
  @override
...
class _InitThemState extends State<DateLnaguageSelectPage3> {
        ...
        children: [
          ...
          FlatButton(
            onPressed: () {
              ...
              //更新当前应用显示的语言环境 
              langGlobalKey1.currentState.changeLocale(Locale('en', 'US'));
            },
            child: Text("选择英文"),
          ),
          FlatButton(
            onPressed: () {
              ...
              //更新当前应用显示的语言环境 
              langGlobalKey1.currentState.changeLocale(Locale('zh', 'CN'));
