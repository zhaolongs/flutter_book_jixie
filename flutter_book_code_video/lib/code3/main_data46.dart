...
//4.2 /lib/code3/main_data46.dart
...
class FirstPagetate extends State<FirstPage>
  ...
  void initState() {
    ...
    tabs = <Tab>[
      ...
      Tab(text: "Tab1",icon: Icon(Icons.add_alert),),
      Tab(text: "Tab2",icon: Icon(Icons.add_comment),),
      Tab(text: "Tab3",icon: Icon(Icons.add_location),),
