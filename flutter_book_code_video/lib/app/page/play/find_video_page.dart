...
import 'package:flutterbookcode/app/page/play/video_play_bottom.dart';
import 'package:flutterbookcode/app/page/play/video_play_detailed_page.dart';
import 'package:flutterbookcode/app/page/play/video_play_right.dart';
...
class FindVideoItemPage extends StatefulWidget {
  ...
  const FindVideoItemPage({Key key, this.videoModel}) : super(key: key);
  @override
