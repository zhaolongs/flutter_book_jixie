...
class TransformRotatePage extends StatefulWidget {
  @override
  _TransformPageState createState() => _TransformPageState();
}

///lib/code23/main_data2314.dart
class _TransformPageState extends State<TransformRotatePage>
  ...
  void initState() {
    ...
    _animationController.addListener(() {
      ///实时更新
      _angleValue = _animationController.value;
      setState(() {});
    });
  }
      ...
      child: Row(
        children: [
          ...
          Padding(
              ...
              child: Text("当前的旋转弧度 ${_angleValue.toStringAsFixed(2)}")),
        ],
      ),
    );
  }
