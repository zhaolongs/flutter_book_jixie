...
//lib/code/main_data1314.dart
//手势识别  双指旋转、缩放、拖动图片
class RoteAndScaleImagePage2 extends StatefulWidget {
  @override
  _TestPageState createState() => _TestPageState();
}

class _TestPageState extends State<RoteAndScaleImagePage2> {
  ///手势的旋转弧度
              ...
              onScaleUpdate: (ScaleUpdateDetails details) {
                ...
                if (focalPoint != downFocalPoint) {
                  ...
                  if (scale == 1.0) {
                    ...
                    flagOffset = (focalPoint - downFocalPoint)/2;
                  } else {
                    ///缩放 计算缩放变化的值
                    _scale = scale - 1.0;
                  }
