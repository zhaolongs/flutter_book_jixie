...
//lib/code10/main_data1101.dart
/// 复选框的基本使用
class CheckBoxBaseUsePage extends StatefulWidget {
  @override
...
class _PageState extends State {
  ...
  buildCheckBoxAndText() {
    return Row(children: [
      ...
      Padding(padding: EdgeInsets.only(left: 1),child: Text("登录代表同意用户协议"),)
    ],);
  }
  ///复选框Checkbox的基本使用
  buildCheckBox() {
